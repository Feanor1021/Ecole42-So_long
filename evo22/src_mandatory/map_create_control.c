...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/08/28 14:24:02 by fyardimc          #+#    #+#             */
/*   Updated: 2022/08/28 14:24:13 by fyardimc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	map_control(t_game *so_long, char *map_name)
{
	...
	if (check_diff_char_check(so_long, "01CEP") == -1)
...
int	check_diff_char_check(t_game *s_l, char *set)
{
	...
	if (s_l->flag != 1 || s_l->flag2 != 1 || flag == 0 || flag2 == 0)
		return (-1);
	return (1);
}
